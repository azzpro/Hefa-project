/*******************************************************************************
 * Project Key : CPPII
 * Create on 2018年10月23日 下午2:35:31
 ...
 * <P>TODO</P>
 * @version 1.0
 * @author 刘建麟  2018年10月23日 下午2:35:31
 */
public class FileConstantsYeepay {
	
	//图片 bucketname 
	public static final String IMAGE_BUCKETNAME = "azz-image";
	
	//文件bucketname
	public static final String FILE_BUCKETNAME = "azz-file";
	
	//平台端图片文件夹
	public static final String PLATFORM_IMAGE_PATH = "plat-image";
	
	//商户端图片文件夹
	public static final String MERCHANT_IMAGE_PATH = "merchant-image";
	...
	//商户端
	public static final int AZZ_MERCHANT = 2;
